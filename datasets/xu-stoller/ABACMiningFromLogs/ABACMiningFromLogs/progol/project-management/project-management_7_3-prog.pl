...
projectRType(proj22).
projectRType(proj21).
expertiseRType(design).
expertiseRType(coding).
ridRType(proj11task2).
ridRType(proj21task2a).
ridRType(proj22task2a).
ridRType(proj12task2).
ridRType(proj12task1).
ridRType(proj11task2prop).
ridRType(proj12task1a).
ridRType(proj12task1propa).
ridRType(proj21task1propa).
ridRType(proj11task2a).
ridRType(proj22task2prop).
ridRType(proj22budget).
ridRType(proj12sched).
ridRType(proj21task1prop).
ridRType(proj11budget).
ridRType(proj11task2propa).
ridRType(proj21task2prop).
ridRType(proj21budget).
ridRType(proj11task1).
ridRType(proj22task1).
ridRType(proj22sched).
ridRType(proj12task2propa).
ridRType(proj22task2propa).
ridRType(proj22task1propa).
ridRType(proj22task1a).
ridRType(proj12task2prop).
ridRType(proj11task1propa).
ridRType(proj11sched).
ridRType(proj12task2a).
ridRType(proj21task2).
ridRType(proj21task1).
ridRType(proj11task1a).
ridRType(proj21task2propa).
ridRType(proj21sched).
ridRType(proj22task1prop).
ridRType(proj12task1prop).
ridRType(proj12budget).
ridRType(proj11task1prop).
ridRType(proj21task1a).
ridRType(proj22task2).
departmentRType(dept2).
departmentRType(dept1).
proprietaryRType(true).
proprietaryRType(false).
typeRType(budget).
typeRType(schedule).
typeRType(task).
